...
# file_path = "C:\\Users\\wq\\Desktop\\kaggle_credict_data\\data\\"
file_path = "/host/home/kagglehomecredit/kaggledata/"
...
def application_train_test(num_rows=None, nan_as_category=False):
    # Read data and merge
    df = pd.read_csv(file_path + 'application_train.csv', nrows=num_rows)
    test_df = pd.read_csv(file_path + 'application_test.csv', nrows=num_rows)
...
def bureau_and_balance(num_rows=None, nan_as_category=True):
    ...
    for e in cols:
        bureau_agg['NEW_RATIO_BURO_' + e[0] + "_" + e[1].upper()] = bureau_agg['ACTIVE_' + e[0] + "_" + e[1].upper()] / \
...
def previous_applications(num_rows=None, nan_as_category=True):
    prev = pd.read_csv(file_path + 'previous_application.csv', nrows=num_rows)
...
if __name__ == "__main__":
    submission_file_name = file_path +  "submission_with_selected_features.csv"
