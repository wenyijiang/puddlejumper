...
def application_train_test(num_rows = None, nan_as_category = True):
    #Read data and merge
    df = pd.read_csv('C:\\Users\\wq\\Desktop\\kaggle_credict_data\\data\\application_train.csv', nrows = num_rows)
    test_df = pd.read_csv('C:\\Users\\wq\\Desktop\\kaggle_credict_data\\data\\application_test.csv', nrows=num_rows)
...
def bureau_and_balance(num_rows = None, nan_as_category = True):
    bureau = pd.read_csv('C:\\Users\\wq\\Desktop\\kaggle_credict_data\\data\\bureau.csv', nrows=num_rows)
    bb = pd.read_csv('C:\\Users\\wq\\Desktop\\kaggle_credict_data\\data\\bureau_balance.csv', nrows=num_rows)
...
def previous_applications(num_rows=None, nan_as_category=True):
    prev = pd.read_csv('C:\\Users\\wq\\Desktop\\kaggle_credict_data\\data\\previous_application.csv', nrows=num_rows)
...
def pos_cash(num_rows=None, nan_as_category=True):
    pos = pd.read_csv('C:\\Users\\wq\\Desktop\\kaggle_credict_data\\data\\POS_CASH_balance.csv', nrows=num_rows)
...
def installments_payments(num_rows = None, nan_as_category = True):
    ins = pd.read_csv('C:\\Users\\wq\\Desktop\\kaggle_credict_data\\data\\installments_payments.csv', nrows = num_rows)
...
def credit_card_balance(num_rows = None, nan_as_category = True):
    cc = pd.read_csv('C:\\Users\\wq\\Desktop\\kaggle_credict_data\\data\\credit_card_balance.csv', nrows = num_rows)
...
def kfold_lightgbm(df, num_folds, stratified=False):
    ...
    test_df[['SK_ID_CURR', 'TARGET']].to_csv("C:\\Users\\wq\\Desktop\\kaggle_credict_data\\data\\lightgbm_improvement.csv", index=False)
